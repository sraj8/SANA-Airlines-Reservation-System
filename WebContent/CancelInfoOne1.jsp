...
<div class="container">
  ...
  <div class="sidebar1">
    <ul class="nav">
      <li><center><b><i><font color="#FFFFFF">Book Ticket</font></i></b></center></li>
      <li><center><b><i><font color="#ffffff">View Ticket</font></i></center></li>
      <li id="boo"><center><i>Cancel Ticket</i></center></li>
    ...
    <section class="wrapper">
				<div id="ad-2">
					...
					<div id="content">
						...
						<a href="http://localhost:8087/Sana/Book1.jsp">Book Tickets!</a>
					</div>
				</div>
            </section></div>
  <!--<div class="footer">-->
